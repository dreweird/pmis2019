...
@Component({
  ...
  <div class="row item" [ngClass]="routeAnimationsElements">
        ...
        <h2>Disbursement Targets</h2>
            ...
            <div  class="col-md-2">
              <button  mat-raised-button class="information" (click)="export()">EXPORT to EXCEL</button> 
...
export class Bed3PlanComponent implements OnInit, OnChanges{
  ...
  export(){
    var ck=["mfo_name","jandt", "febdt", "mardt","Q1", "aprdt", "maydt", "jundt" ,"Q2" , "juldt", "augdt", "sepdt" ,"Q3", "octdt", "novdt", "decdt" ,"Q4","to"];
    ...
    this.gridApi.exportDataAsExcel({
      customHeader  : [
        ...
        [{styleId:'headappend',data:{type:'String', value:'BED3- Disbursement Target 2019'}}],
    ...
    this.columnDefs = [
      ...
      },
      {
        ...
        children: [
          ...
          {
            cellClass:['data','p2'],headerName: 'TOTAL',
            field: 'to',
            width: 120,
